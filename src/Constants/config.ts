...
globalAPI.interceptors.request.use(
  async config => {
    ...
    // }
          config.headers.Authorization = `bearer eyJhbGciOiJodHRwOi8vd3d3LnczLm9yZy8yMDAxLzA0L3htbGRzaWctbW9yZSNobWFjLXNoYTI1NiIsInR5cCI6IkpXVCJ9..Ya-r12ylQmmgNq3J4ZcOMXN-2S6Dakbs7eFs4jPC-Kw`;
