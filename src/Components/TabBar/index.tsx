    ...
    return (
        <View style={[layout.rowBox, styles.containner]}>
            <Pressable style={styles.tapcon} onPress={()=>onPress("Market")}>
                ...
                <Text style={[styles.tabText, { color: (route.name === "Market") ? theme.active : theme.deactive,
            ...
            <Pressable style={styles.tapcon}  onPress={()=>onPress("Sellers")}>
                ...
                <Text style={[styles.tabText, { color: (route.name === "Sellers") ? theme.active : theme.deactive,
            ...
            <Pressable style={styles.tapcon} onPress={()=>onPress("Boursa")}>
                ...
                <Text style={[styles.tabText, { color: (route.name === "Boursa") ? theme.active : theme.deactive,
              ...
              <Pressable style={styles.tapcon} onPress={()=>onPress("Notifications")}>
                ...
                <Text style={[styles.tabText, { color: (route.name === "Notifications") ? theme.active : theme.deactive,
