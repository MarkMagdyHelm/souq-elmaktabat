                ...
                <View style={styles.con1}>
                    <View style={[layout.dirRow, { justifyContent: "space-between", alignItems: "center" }]}>
                        <View style={styles.statusBtn}>
                            <Text style={styles.statusText}>{item.status==="طلب جديد"?"قيد الانتظار":  
                                 item.status==="new order"? "pinging" : item.status} </Text>
                        </View>
                    ...
                    <Text style={[layout.textAlign, styles.quantity,{marginTop:PixelPerfect(8)}]}>{t("date")} {date}  </Text>
