...
const Product = (props: Props) => {
  const { item, isOfffer, onPress, onFavPress } = props;
      ...
      <View style={[styles.con]}>
        ...
        <View style={[layout.dirRow, styles.priceRateRow]}>
          ...
          {(item?.type == 2 || item?.type == 1) && (
            <Text style={[layout.textAlign, styles.price]}>
              {item?.type == 2
                ? item?.price + t('pound')
                : item?.price + t('pound')}
            </Text>
        ...
        <TouchableOpacity onPress={onPress} style={[styles.con1]}>
