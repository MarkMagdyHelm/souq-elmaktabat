      ...
      <View style={[layout.rowBox, styles.inputContainner, inputCon]}>
        {isPhone && (
          <View style={[layout.rowBox, styles.phoneCon]}>
            ...
            >
              <Text style={styles.phonecodetext}>+{callingCode}</Text>
            </TouchableOpacity>
            <CountryPicker
        ...
        />
        {password && (
          <Pressable style={styles.eyecon} onPress={onPress}>
...
const useStyles = (
  ...
  StyleSheet.create({
    ...
    phoneCon: {
      ...
      height: PixelPerfect(50),
      borderLeftWidth: 1,
      //   [dir != 'rtl' ? 'paddingRight' : 'paddingLeft']: PixelPerfect(2),
      //   marginRight: PixelPerfect(-1),
