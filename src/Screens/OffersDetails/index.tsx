...
console.log('====================================');
    return (
        <Container showHint={false}>
            ...
            <HeaderWithText title={t("offer_details")}
                isShareVisible={true}
                 onFavClick={() => {
                    console.log(item);
            ...
            <CancelOrder visible={visibleCancel}
                ...
                }} title={t("delete_offer")} body={t("confirmCancelOffer")} cancleText={t("yesCancelOffer")} />
                    ...
                    <View>
                        ...
                        <View style={styles.info}>
                            ...
                            <View style={[layout.rowBox, { justifyContent: "space-between", marginVertical: PixelPerfect(4) }]}>
                                ...
                                <Text style={[layout.textAlign, styles.note1]}>{fullDate + " " + t("orUntilOutOfStock")}</Text>
                            </View>
                            <View style={[layout.rowBox, { justifyContent: "space-between", marginVertical: PixelPerfect(4) }]}>
                            ...
                            <TouchableOpacity style={[layout.rowBox, styles.orderBtn]} onPress={() => {
                              navigation.navigate("EditOffer",{
                                ...
                                <Text style={[layout.textAlign, styles.orderBtnText]}>{t("edit")}</Text>
                            </TouchableOpacity>
