    ...
    return (
        <Container showHint={false}>
            <Content style={styles.page} noPadding>
                <HeaderWithText title={"ملف البائع"} />
                ...
                <View style={styles.headerCard}>
                    ...
                    <Text style={styles.verified}>تم نشر الحساب كبائع</Text>
                </View>

                {/* Stats row */}
                <View style={styles.statsRow}>
                    {[
                        { v: '10', l: 'التقييمات عدد' },
                        { v: '10', l: 'الطلبات عدد' },
                        { v: '10', l: 'العروض عدد' },
                    ].map((s, i) => (
                ...
                <View style={styles.block}>
                    <Text style={styles.blockTitle}>معلومات الحساب</Text>
                ...
                {/* About */}
                <View style={styles.block}>
                    <Text style={styles.blockTitle}>عن المؤسسة</Text>
                    <Text style={styles.paragraph}>
                        متخصصون في ورق الطباعة والكتابة عالي الجودة ومتخصصون في ورق الطباعة والكتابة عالي الجودة
                    </Text>
                </View>

                {/* Tools - inline separated like design */}
                <View style={styles.block}>
                    <Text style={styles.blockTitle}>ادوات المؤسسة</Text>
                    <View style={styles.listRow}>
                        {['ورق','احبار','مكن تصوير','ادوات مكتبية'].map((txt, idx, arr)=> (
                ...
                <View style={[styles.block, styles.outlined]}> 
                    <Text style={styles.blockTitle}>نشاط المؤسسة</Text>
                    <View style={styles.listRow}>
                        {['مكتبات','شركات التوريدات','مطابع'].map((txt, idx, arr)=> (
                            <View key={idx} style={styles.listPair}>
                                <Text style={styles.listItem}>{txt}</Text>
                                {idx !== arr.length - 1 && <Text style={styles.separatorDot}>·</Text>}
                            </View>
                ...
                {/* Payment methods */}
                <View style={styles.block}>
                    <Text style={styles.blockTitle}>طرق الدفع</Text>
                    <Text style={styles.bullets}>• بطاقة بنكية (Visa / Mastercard)</Text>
                    <Text style={styles.bullets}>• المحافظ الإلكترونية (فودافون كاش)</Text>
                    <Text style={styles.bullets}>• الدفع عند الاستلام (Cash on Delivery)</Text>
                </View>
            </Content>
        </Container>
    )
