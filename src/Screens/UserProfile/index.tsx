        ...
        <Container showHint={false}>
            <Content style={styles.page} noPadding>
                ...
                <View style={styles.statsRow}>
                    {[{ v: '10', l: 'عدد الطلبات' }, { v: '10', l: 'عدد التقييمات' }].map((s, i) => (
                ...
                <View style={styles.block}>
                    ...
                    <View style={styles.infoRow}><Text style={styles.infoIcon}>🗺️</Text><Text style={styles.infoText}>القاهره - عين شمس</Text></View>
                </View>

                {/* Interested markets */}
                <View style={styles.block}>
                    <Text style={styles.blockTitle}>الأسواق التي تهمك</Text>
                    {['ورق','احبار','مطابع'].map((txt, idx)=> (
