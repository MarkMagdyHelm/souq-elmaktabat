...
import { GetAllActivitiesHandler, GetAllAvailableToolsHandler, GetAllRegionsByCountryIdHandler } from '../../../Apis/Appinfo';
...
const Index = (props: Props) => {
    ...
    const { countries, activites, payments } = useSelector((state: RootState) => state.settings);
    ...
    const updateUserProfile = async (values: any) => {
        ...
        console.log([state.selecteMarket.id]);
                ...
                <Content style={{  }}>
                    ...
                    <Formik
                        ...
                        initialValues={{
                            ...
                            Market:dir=="rtl"?item.info?.activities[0]?.arName:item.info?.activities[0]?.name,
                                ...
                                <>
                                    <Content
                                        ...
                                        >
                                            ...
                                            {errors.Market && touched.Market && <Text style={styles.errorText}>{t(errors.Market as any)}</Text>}
                                        </Pressable>
                                            ...
                                            <DropDowenMenu
                                                onCloseFn={(val) => {
                                                    ...
                                                    if (typeof val?.id === "string") {
                                                        ...
                                                        setFieldError("governmen", "You must pick a activity!");
                                                    } else {
