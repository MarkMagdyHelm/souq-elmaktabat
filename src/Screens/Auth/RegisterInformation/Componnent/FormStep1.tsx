...
import PhoneInputWithCountry from '../../../../Components/touchables/PhoneInputWithCountry';
        ...
        <>
          ...
          >
            ...
            {errors.Role && touched.Role && (
              <Text style={styles.errorText}>{t(errors.Role as any)}</Text>
            )}
          </Pressable>
