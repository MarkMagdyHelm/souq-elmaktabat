...
import { AddFavouritePaperOffer, GetFavouriteUsers } from '../../Apis/CommonApi'
            ...
            <View style={styles.page} >
                ...
                {tab === 'offers' ? (
                    ...
                    <FlatList
                        ...
                        showsVerticalScrollIndicator={false}
                        renderItem={({ item }) => 
                        <SellerItem isOfffer={false} item={item} onPress={() => {
                        ...
                        columnWrapperStyle={[layout.rowBox,{
                            marginVertical: PixelPerfect(4),
                            justifyContent: state.users.length === 1 ? "flex-end" : "space-between",
