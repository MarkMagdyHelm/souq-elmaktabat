            ...
            <Content style={styles.page} noPadding>
                ...
                <View style={styles.tabsRow}>
                    <Pressable style={[styles.tab, tab === 'offers' ? styles.tabActive : styles.tabInactive]} onPress={() => setTab('offers')}>
                        <Text style={[styles.tabText, tab === 'offers' ? styles.tabTextActive : styles.tabTextInactive]}>{t('offers')}</Text>
                    </Pressable>
                    <Pressable style={[styles.tab, tab === 'sellers' ? styles.tabActive : styles.tabInactive]} onPress={() => setTab('sellers')}>
                        <Text style={[styles.tabText, tab === 'sellers' ? styles.tabTextActive : styles.tabTextInactive]}>{t('sellers')}</Text>
                    </Pressable>
                </View>
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            <View style={styles.sellerCard}>
                                ...
                                <Text style={styles.desc}>{t('specializedIn')}</Text>
                                <Text style={styles.count}>67 : {t("productsCount")}</Text>
                                <Pressable style={styles.detailsBtn}><Text style={styles.detailsText}>{t("viewDetails")}</Text></Pressable>
                            </View>
                        )}
