...
const Index = (props: Props) => {
    ...
    const { isLogin } = useSelector((state: RootState) => state.auth);
      ...
      const userProfile = () => {
            setstate(old => ({ ...old, loading: true }))
            dispatch<any>(UserProfile((res, status) => {
                  if (res.status === 200) {
                  ...
                  <View style={styles.con} >
                        ...
                        <View style={[layout.rowBox, { alignItems: "center", flex: 0.1, backgroundColor: theme.white }]}>
                              ...
                              <View style={{ marginHorizontal: PixelPerfect(8) }}>
                                    <Text style={[layout.textAlign, styles.seller]}>{(seller.userName ?? seller.name)}</Text>
                                    <View style={[layout.rowBox, { marginTop: PixelPerfect(4) }]}>
                                          <Stars rating={(seller.userRateAverage ?? seller.rate)} rateCount={(seller.userRateCount ?? seller.rateCount)} />
                                    </View>
                              </View>
                        ...
                        <View style={[layout.rowBox, styles.tabs]}>
                              ...
                              <Pressable
                                    ...
                                    <Text
                                          style={[styles.tabText, tab === "informations" && styles.activeTabText]}
                                    >
                                          {t("informations")}
                                    </Text>
                              </Pressable>
                              <Pressable
                                    ...
                                    <Text style={[styles.tabText, tab === "Ratings" && styles.activeTabText]}>
                                          {t("Ratings")}
                                    </Text>
                              </Pressable>
                        </View>
                        ...
                        {state.viewOffers && <View style={{
                              ...
                              <FlatList
                                    ...
                                    columnWrapperStyle={{
                                          ...
                                          justifyContent: state.sellerData?.offers?.paperOffers?.length === 1 ? "flex-end" : "space-between",
                                    }}
                        ...
                        {state.viewRate && <View style={{
                              ...
                              <View style={[styles.header]}>
                                    <Text style={[layout.textAlign, styles.title]}>{t("seller_rate")}</Text>
