...
const Index = (props: Props) => {
    ...
    const filters = ["السعر", "الحجم", "نوع الورق", "المحافظة"];
    ...
    return (
        <Container showHint={false}>
            ...
            <View style={{ flex: 1, paddingHorizontal: PixelPerfect(16) }}>
                ...
                />}
                {state.viewPaperType && <MultiChekers
                    onCloseFn={(val) => {
                        if (Array.isArray(val)) {
                            setstate(old => ({
                                ...old,
                ...
                />}
                {state.viewPaperSize && <MultiChekers
                    onCloseFn={(val) => {
                        if (Array.isArray(val)) {
                            setstate(old => ({
                                ...old,
                ...
                <FlatList
                    ...
                    numColumns={2}
                    columnWrapperStyle={{ marginHorizontal: PixelPerfect(4), marginVertical: PixelPerfect(4), justifyContent: 'space-between' }} // optional spacing
                />
