...
const Index = (props: Props) => {
    ...
    const getRequests = (page: number = 1, loadMore: boolean = false) => {
        ...
        dispatch<any>(
          ...
          GetMyRequests({ statusId: selectedTab == 0 ? null : selectedTab, 
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        ...
                        >
                            ...
                            >
                                {GetNamesByLang(item, "rtl")==="طلب جديد"?"قيد الانتظار":  
                                 GetNamesByLang(item, "rtl")==="new order"? "pinging" : GetNamesByLang(item, "rtl")}
                            </Text>
                        </TouchableOpacity>
                    )}
                />
...
const useStyles = (Fonts: IFont, theme: ITheme, darkmode: boolean, dir: string) =>
    StyleSheet.create({
        ...
        tabText: { 
            textAlign: "center", color: theme.black, fontSize: PixelPerfect(16), fontFamily: Fonts.medium },
        footerLoader: {
